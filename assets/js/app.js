...
searchField.addEventListener("input", function () {
    ...
    if (searchField.value) {
        searchTimeout = setTimeout(() => {
            fetchData(url.geo(searchField.value), function (locations) { // Assumed locations from fetchData
                searchField.classList.remove("searching");
                ...
                const items = []; // Declare items here
                ...
                for (const { name, lat, lon, country, state } of locations) {
                    ...
                    searchItem.innerHTML = `
                        ...
                        <div>
                            ...
                            <p class="label-4 item-subtitle">${state || ""} ${country}</p>
                        </div>
                            ...
                            <div class="card card-sm highlight-card one">
                                ...
                                <div class="wrapper">
                                    ...
                                    <ul class="card-list">
                                        ...
                                        <li class="card-item">
                                            <p class="title-1">${pm2_5.toPrecision3}</>
                                ...
                                <div class="card-list">
                                    ...
                                    <div class="card-item">
                                        ...
                                        <div>
                                            ...
                                            <p class="title-1">${module.getTime(sunriseUnixUTC, timezone)} AM</p>
                                        </div>
                                    ...
                                    <div class="card-item">
                                        ...
                                        <div>
                                            ...
                                            <p class="title-1">${module.getTime(sunsetUnixUTC, timezone)} PM</p>
                                        </div>
